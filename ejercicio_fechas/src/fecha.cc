...
std::string OrdenarFechas(std::vector <Fechas> fechas_ordenar, std::string fichero_salida){
  ...
  for (int k = 0; k < fechas_ordenar.size(); ++k){
    ...
    std::string str4 = (str1 + caracter + str2 + caracter + str3 + '\n');
    std::cout << str4;
    fichero_modificado << str4;
    return str4;
  }
